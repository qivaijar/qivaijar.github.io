...
export const items: Array<Experience> = [
	{
		...
		logo: Assets.Prosa,
		shortDescription:
			'Lead the Prosa Text-to-Speech (TTS), cross-functional, product development team.'
	},
	{
	...
	},
	{
		...
		type: 'Software Development (NLP-Based AI Products)',
		location: 'Bandung, Indonesia',
		period: { from: new Date('2020-05'), to: new Date('2021-06') },
		...
		logo: Assets.Prosa,
		shortDescription:
			'Developed AI-based solutions for Text-to-Speech (TTS) and Paralinguistic systems.'
	},
	{
		slug: 'nsl',
		...
		logo: Assets.Nsl,
		shortDescription:
			'Worked on research involving the implementation of machine learning technologies in wireless communication systems.'
	}
];
